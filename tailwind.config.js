...
export default {
  // content option is ignored in v4 but harmless if present
  content: ['./index.html', './src/**/*.{js,ts,jsx,tsx}'],
  theme: {
    extend: {
      colors: {
        parchment: { 50:'#F7F5F2', 100:'#EEECE7', 200:'#E8E3DA', 300:'#DCD5CA' },
        bark:      { 700:'#5C534A', 800:'#4A423C', 900:'#3D3630', 950:'#2A241F' },
      ...
      keyframes: {
        ...
        'bounce-gentle': { '0%, 100%': { transform: 'translateY(0px)' }, '50%': { transform: 'translateY(-5px)' } },
        glow: { '0%': { boxShadow: '0 0 20px rgba(240,119,92,0.3)' }, '100%': { boxShadow: '0 0 30px rgba(240,119,92,0.5)' } },
        'rotate-slow': { '0%': { transform: 'rotate(0deg)' }, '100%': { transform: 'rotate(360deg)' } },
        'slide-up': { '0%': { transform: 'translateY(20px)', opacity: '0' }, '100%': { transform: 'translateY(0px)', opacity: '1' } },
