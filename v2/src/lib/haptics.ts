 ...
 * (Ported verbatim from v1 — production-quality, theme-independent.)
 *
 ...
 *
 * Gated on two things:
 *   1. The user's haptics preference, mirrored to localStorage so this module
 *      can decide synchronously on the tap path.
