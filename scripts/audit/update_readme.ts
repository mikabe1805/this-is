...
interface AuditResult {
  ...
  direct_usages: any[];
  optimized_usages: any[];
}

function loadAuditData(): AuditResult | null {
  try {
...
function generateReadme(audit: AuditResult | null): string {
...
**Generated by:** \`scripts/audit/update_readme.ts\`  
